    	...
    	<template #reference>
      	<el-button type="info" plain>指标</el-button>
			...
			<el-row justify="center">
				<el-col :span="12"><span>请选择指标</span></el-col>
				<el-col :span="12">
					<el-checkbox
						v-model="checkFieldAll"
...
export default defineComponent({
	...
	methods: {
		...
		handleCheckedFieldChange(value: string[]) {
  		...
  		this.isIndeterminate = checkedCount > 0 && checkedCount < this.indexParams.length;
